...
def win32_unicode_console():
    ...
    def _complain(message):
        original_stderr.write(message if isinstance(
    ...
    try:
        ...
        if real_stdout or real_stderr:
            WriteConsoleW = WINFUNCTYPE(BOOL, HANDLE, LPWSTR, DWORD, POINTER(
                DWORD), LPVOID)(("WriteConsoleW", windll.kernel32))
                        ...
                        if self._hConsole is None:
                            ...
                            while remaining:
                                ...
                                if retval == 0 or n.value == 0:
                                    raise IOError(
                                        "WriteConsoleW returned %r, n.value = %r" % (retval, n.value))
                                remaining -= n.value
                                if not remaining:
                                    break
                                text = text[n.value:]
